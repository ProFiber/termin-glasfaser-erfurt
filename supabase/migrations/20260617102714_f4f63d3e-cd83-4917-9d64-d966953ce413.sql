...
BEGIN
  INSERT INTO public.contacts (bid,strasse,hnr,hnr_zusatz,plz,ort,name,email,mobil,festnetz,typ,we,ge,zustimmung,lat,lng,auskundung_von,auskundung_bis,nvt,auskundung_erforderlich,auskundung_status,auskundung_erfolgt,auskundung_ergebnis)
  SELECT
    (rec->>'bid')::text,
