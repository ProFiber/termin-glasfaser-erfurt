  ...
  LOOP
    ...
    IF v_bid IS NULL THEN
      INSERT INTO contacts (bid, strasse, hnr, hnr_zusatz, plz, ort, name, nvt,
        ...
        auftrag_typ, bestellnummer, installation_faellig, auftrag_erstellt_am,
        storniert_telekom, auftragsquelle)
    ...
    ELSE
      UPDATE contacts SET
        ...
        auftrag_erstellt_am = coalesce(nullif(rec->>'auftrag_erstellt_am','')::timestamptz, auftrag_erstellt_am),
