...
BEGIN
  ...
  LOOP
    ...
    ON CONFLICT (bid) DO UPDATE SET
      ...
      -- Rohfeld aus Excel: bei leerer Zelle explizit auf NULL setzen, sonst würde sich Status nicht zurückdrehen
    ...
    -- doku_states spiegelt die Excel-Rohfelder direkt (auch False, damit Status "unvollständig" korrekt greifen kann)
