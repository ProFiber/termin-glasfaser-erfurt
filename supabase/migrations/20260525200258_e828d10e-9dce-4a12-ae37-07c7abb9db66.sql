...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO call_states (bid, status, erledigt_datum, grabenlaenge,
      umsatz_eur, zusatz_eur, aufmass_am, gutschrift_am, avis_am, verguetet_am,
    ...
    ON CONFLICT (bid) DO UPDATE SET
      ...
      gutschrift_am = coalesce(nullif(rec->>'gutschrift_am','')::date, call_states.gutschrift_am),
