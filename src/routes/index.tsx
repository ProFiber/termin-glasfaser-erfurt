...
function ExportMenu({
  ...
  const storniertCount = baseList.filter((c) => c.storniert && callStates[c.bid]?.status !== "erledigt" && callStates[c.bid]?.status !== "abgelehnt").length;
  const offenCount = baseList.length - erlCount - abgCount - storniertCount;
    ...
    <div style={{ fontFamily: "system-ui,-apple-system,sans-serif", maxWidth: 480, margin: "0 auto", background: "#f2f2f7", minHeight: "100dvh", paddingBottom: "calc(56px + env(safe-area-inset-bottom, 0px))", boxSizing: "border-box" }}>
      ...
      <div style={{ background: "white", borderBottom: "1px solid #e5e7eb", padding: "8px 12px", display: "flex", flexDirection: "column", gap: 7 }}>
        ...
        <div style={{ display: "flex", gap: 5, overflowX: "auto" }}>
          {(["alle", "offen", "nichtErledigt", "termin", "terminVergangen", "erledigt", "abgelehnt", "storniert", "abgelehntStorno", "erlNurWir", "erlNurTK", "erlBeide", "stornoTK", "stornoWir", "stornoBeide", "stornoErledigt", "klarfall", "telUngueltig", "kurzKandidat", "kurzAnschluss", "langAnschluss", "bulk", "angerufen", "nichtErreicht", "ohneZustimmung", "erlOhneZustimmung", "erlOhneAuftrag", "imBauHeute", "nurGE", "auskundungErledigt", "auskundungOffen", "nochOffen"] as const).map((f) => {
            const secondary = f === "klarfall" || f === "telUngueltig" || f === "kurzKandidat" || f === "kurzAnschluss" || f === "langAnschluss" || f === "bulk" || f === "angerufen" || f === "nichtErreicht" || f === "terminVergangen" || f === "ohneZustimmung" || f === "erlOhneZustimmung" || f === "erlOhneAuftrag" || f === "imBauHeute" || f === "nurGE" || f === "auskundungErledigt" || f === "storniert" || f === "nichtErledigt" || f === "abgelehntStorno" || f === "auskundungOffen" || f === "nochOffen" || f === "erlNurWir" || f === "erlNurTK" || f === "erlBeide" || f === "stornoTK" || f === "stornoWir" || f === "stornoBeide" || f === "stornoErledigt";
